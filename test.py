...
def distance_matrix(data, numeric_distance="euclidean", categorical_distance="jaccard"):
    ...
    if numeric_distance not in possible_continuous_distances:
        print
        "The continuous distance " + numeric_distance + " is not supported."
        return None
    elif categorical_distance not in possible_binary_distances:
        print
        "The binary distance " + categorical_distance + " is not supported."
        return None
...
def knn_impute(target, attributes, k_neighbors, aggregation_method="mean", numeric_distance="euclidean",
    ...
    if k_neighbors > number_observations or k_neighbors < 1:
        print
        "The range of the number of neighbors is incorrect."
        return None
...
attributes=data
k_neighbors=3
print(knn_impute(target,attributes,k_neighbors))